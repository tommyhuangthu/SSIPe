...
Input files:
    ...
    force_field (optional: SSIP  - profile score only
...
#def make_webpage2(inv_resi_dict,data_dir,isscore,force_field,result_list):
def make_webpage2(data_dir,isscore,force_field,result_list):
...
def get_final_score2(data_dir):
    ...
    #### get final score ####
    sys.stdout.write("step 4: get_final_score\n")
    ...
    result_list=["%-7.3f %-9.3f %s"%(f,s,m) for f,s,m in zip(finalscore_list,ssipscore_list,mutation_list)]
    fp=open(result_file,'w')
    fp.write('DDG     SSIPscore mutations\n')
    fp.write('\n'.join(result_list)+'\n')
    fp.close()
    ...
    #### make html output ####
    sys.stdout.write("step 5: index.html\n")
    #make_webpage2(inv_resi_dict,data_dir,isscore,force_field,result_list)
    make_webpage2(data_dir,isscore,force_field,result_list)
...
if __name__=="__main__":
    ...
    for arg in sys.argv[1:]:
        get_final_score2(os.path.abspath(arg))
